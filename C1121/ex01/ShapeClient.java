...
class ShapeClient {
  public static void main(String[] args) {
    ...
    */
    ...
    System.out.println("2. After sorting using Comparable...");
    for (GeometricObject shape: shapeList) {
        System.out.println(shape.getArea());
    }
    System.out.println("3. After sorting using Comparator...");
    
    // Comparator<GeometricObject> areaComparator = new GeometricObjectAreaComparator();
    Collections.sort(shapeList, (lhs, rhs) -> Double.compare(lhs.getArea(), rhs.getArea()));
    for (GeometricObject shape: shapeList) {
        System.out.println(shape.getArea());
    }
